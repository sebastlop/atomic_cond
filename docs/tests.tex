...
similar behavior occur with the increasing of $N_H$ above 
...
$\mathcal{L}^{ERR}_{\theta}$ produces more soft optimization 
curves, and, except for the case of $N_H=32$ with $\tanh$ 
activation function in panel (d) this loss does not produce 
overfitting or increasing in the optimization process. The 
opposite behavior can be observed for 
...
activation is more adequate, but some other metrics can 
be analyzed to decide the activation function to use.
